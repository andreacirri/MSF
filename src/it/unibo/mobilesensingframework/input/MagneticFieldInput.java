 ...
 */
public class MagneticFieldInput implements IInput, SensorEventListener {

	/** The Constant DEBUG. */
	private final static boolean DEBUG = true && it.unibo.mobilesensingframework.debug.Debug.DEBUG_SYSTEM;
	
	/** The Constant TAG. */
	private final static String TAG = MagneticFieldInput.class.getCanonicalName();
	 ...
	 */
	public MagneticFieldInput(Context context, int sensorRate) {
		_context = context;
