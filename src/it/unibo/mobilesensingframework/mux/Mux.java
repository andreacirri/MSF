...
public class Mux implements IMux{
	...
	public Mux(){
	    ...
	    _disruptor =
	        new Disruptor<ValueEvent>(ValueEvent.EVENT_FACTORY, _executor,
	...
	public void start(){
	    ...
	    if(DEBUG)Log.i(TAG,"Buffer avviato at "+_start);
	}

	/* (non-Javadoc)
	 * @see it.unibo.mobilesensingframework.mux.IMux#sendEvent(android.hardware.SensorEvent)
	 */
	...
	/* (non-Javadoc)
	 * @see it.unibo.mobilesensingframework.mux.IMux#registryHandler(com.lmax.disruptor.EventHandler)
	 */
	public void registryHandler(EventHandler<ValueEvent> eventHandler) {
		// TODO Auto-generated method stub
		_disruptor.handleEventsWith(eventHandler);
		if(DEBUG) Log.i(TAG, "Aggiunto handler");
		start();
	}
